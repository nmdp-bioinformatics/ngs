...
public class Pruner<L, W> {
    ...
    protected static abstract class Init<L, W, T extends Init<L, W, T>> {
        ...
        /**
         * Initialize labels assigned for pruning.
         *
        ...
        /**
         * Initialize weights assigned for pruning.
         *
        ...
        /**
         * Initialize traversed path memory.
         *
        ...
        /**
         * Build a fully initialized pruner.
         *
     ...
     * @param init 
     */
    protected Pruner(final Init<L, W, ?> init) {
        this();
        path = new Path();
    ...
    /**
     * Pruning edges and target vertexes. If the pruner is told it will
    ...
    /**
     * Retrieving the traversed path.  If the pruner has no memory the
